    ...
    <div class="mb-2 rounded-top rounded-bottom">
        ...
        <div class="pt-2 pr-2 pl-2 pb-0 box-body rounded-bottom">
            <div class="mb-2">
                ...
                <div v-if="error" class="box-content-record">
                    {{error}}
                </div>
                <div v-else-if="!streams || streams.length === 0" class="box-content-record">
                    No Quake streams online.
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        getStreams() {
            StreamService.getStreams().then(response => {
