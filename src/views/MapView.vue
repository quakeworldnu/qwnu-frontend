<template>
    <div v-if="map" class="ml-3 mb-2 rounded-top rounded-bottom main-container">
        ...
        <div class="p-2 pb-0 box-body rounded-bottom">
            <div class="p-1 rounded-top rounded-bottom">
                    ...
                    <div class="mb-2 rounded">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div
                                    v-for="(screenshot, index) in map.screenshots"
                                    :key="screenshot.id"
                                >
                                    <h3
